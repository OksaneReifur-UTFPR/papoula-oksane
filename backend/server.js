...
const PORT_FIXA = 3000; // Porta fixa
...
const pagamentoHasFormaDePagamentoRoutes = require('./routes/pagamentoHasFormaDePagamentoRoutes');
app.use('/pagamento_has_forma_de_pagamento', pagamentoHasFormaDePagamentoRoutes);

const pessoaRoutes = require('./routes/pessoaRoutes');
app.use('/pessoa', pessoaRoutes);

 const plantaRoutes = require('./routes/plantaRoutes');
 app.use('/planta', plantaRoutes); //Registrando as rotas de planta
